...
- When 'A' selected: Execute {project-root}/.agent/bmad/core/workflows/advanced-elicitation/workflow.xml
- When 'P' selected: Execute {project-root}/.agent/bmad/core/workflows/party-mode
