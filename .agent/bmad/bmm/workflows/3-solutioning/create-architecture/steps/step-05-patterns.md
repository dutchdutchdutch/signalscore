...
- Read fully and follow: {project-root}/.agent/bmad/core/workflows/advanced-elicitation/workflow.xml with current patterns
...
- Read fully and follow: {project-root}/.agent/bmad/core/workflows/party-mode/workflow.md with implementation patterns context
