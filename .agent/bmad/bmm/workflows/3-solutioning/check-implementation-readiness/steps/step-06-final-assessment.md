...
# Path Definitions
workflow_path: '{project-root}/.agent/bmad/bmm/workflows/3-solutioning/implementation-readiness'
...
Implementation Readiness complete. Read fully and follow: `.agent/bmad/core/tasks/bmad-help.md` with argument `implementation readiness`.
