...
# Path Definitions
workflow_path: '{project-root}/.agent/bmad/bmm/workflows/3-solutioning/create-epics-and-stories'
...
# Task References
advancedElicitationTask: '{project-root}/.agent/bmad/core/workflows/advanced-elicitation/workflow.xml'
partyModeWorkflow: '{project-root}/.agent/bmad/core/workflows/party-mode/workflow.md'
...
Epics and Stories complete. Read fully and follow: `.agent/bmad/core/tasks/bmad-help.md` with argument `Create Epics and Stories`.
