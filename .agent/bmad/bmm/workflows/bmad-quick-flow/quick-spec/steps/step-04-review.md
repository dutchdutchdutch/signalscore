...
workflow_path: '{project-root}/.agent/bmad/bmm/workflows/bmad-quick-flow/quick-spec'
...
1. **Invoke Adversarial Review Task**:
       ...
       <invoke-task>Review {finalFile} using {project-root}/.agent/bmad/core/tasks/review-adversarial-general.xml</invoke-task>
