...
workflow_path: '{project-root}/.agent/bmad/bmm/workflows/bmad-quick-flow/quick-dev'
...
```xml
<invoke-task>Review {diff_output} using {project-root}/.agent/bmad/core/tasks/review-adversarial-general.xml</invoke-task>
```
