...
- The `{project-root}/.agent/bmad/core/tasks/validate-workflow.xml` framework will automatically:
...
3. **Load validation framework**: `{project-root}/.agent/bmad/core/tasks/validate-workflow.xml`
