...
- Read fully and follow: {project-root}/.agent/bmad/core/workflows/advanced-elicitation/workflow.xml with the current design system content
...
- Read fully and follow: {project-root}/.agent/bmad/core/workflows/party-mode/workflow.md with the current design system choice
