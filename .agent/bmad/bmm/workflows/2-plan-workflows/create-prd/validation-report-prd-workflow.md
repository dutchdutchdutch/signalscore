...
**Workflow Being Validated:** .agent/bmad/bmm/workflows/2-plan-workflows/create-prd
...
- ✅ Party-mode workflow: Exists at `{project-root}/.agent/bmad/core/workflows/party-mode/workflow.md`
- ✅ Advanced-elicitation task: Exists at `{project-root}/.agent/bmad/core/workflows/advanced-elicitation/workflow.xml`
...
- Path: `{project-root}/.agent/bmad/bmm/config.yaml`
