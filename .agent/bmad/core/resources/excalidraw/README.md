...
helpers: '{project-root}/.agent/bmad/core/resources/excalidraw/excalidraw-helpers.md'
json_validation: '{project-root}/.agent/bmad/core/resources/excalidraw/validate-json-instructions.md'
```
