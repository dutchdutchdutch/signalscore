...
const SAMPLE_DATA = {
    company: 'ACME Anvils',
    categories: [
        { name: 'AI Keywords', score: 92, weight: '25%', boost: '+23.0' },
        { name: 'Agentic Signals', score: 65, weight: '20%', boost: '+13.0' },
        { name: 'Modern Tool Stack', score: 88, weight: '20%', boost: '+17.6' },
        { name: 'AI in Non-Engineering Roles', score: 75, weight: '25%', boost: '+18.8' },
        { name: 'AI Platform Team', score: 100, weight: '10%', boost: '+10.0' },
    ],
};
